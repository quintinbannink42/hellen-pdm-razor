...
Schematic: SuperSeal **TE 6473418-1** vertical (Link Razor-compatible nets; same pin numbers as former RA 9-6437287-8), M6 bolt-through bobbins VBAT+/GND + power entry/IGN_SW divider, sheets **MM144** / **HP** (**BTS50010-1TAD** ×4) / **ADIO** (**BTS7004-1EPP** ×8 + sense/PU). PCB: 104×93 mm frame, mega-mcu144 0.7 west of a vertical SuperSeal EMI wall, power/PROFET/M6 east. Parts/kILIS: [HARDWARE_BOM.md](HARDWARE_BOM.md). Status: [BOARD.md](BOARD.md).
